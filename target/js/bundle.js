...
function calculator() {
    ...
    function calcTotal() {
        ...
        if (sex == 'female') {
            ...
            result.textContent = Math.round((99.36 + (13.4 * weight) + (4.8 * height) - (5.7 * age)) * ratio);
        }
    }
...
function forms(formSelector,modalTimerId) {
    ...
    const message = {
        ...
        success: 'Thanks',
        failure: 'Something have going wrong'
    };
...
`;
    ...
    dots.forEach(dot => {
        dot.addEventListener('click', (click) => {
            const slideTo = click.target.getAttribute('data-slide-to');
...
window.addEventListener('DOMContentLoaded', (e) => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_1__["default"])('.timer','2022-08-27');
